...
!r.placeModule("utils", function(e) {
    var t = .05;
    return {
        lerp: function(e, n, r) {
            var i = e + r * (n - e);
...
!r.placeModule("activity", function(e) {
    function t(e) {
        return e >= 1e6 ? (e / 1e6).toFixed(2) + "m" : e >= 1e5 ? parseInt(e / 1e3, 10) + "k" : e >= 1100 ? (e / 1e3).toFixed(1) + "k" : e.toString()
    }
    return {
        $el: null,
        initialized: !1,
...
!r.placeModule("api", function(e) {
    var t = e("r")
      , n = function(e) {
        return window.location.hostname == "oauth.reddit.com" ? window.location.protocol + "//www.reddit.com" + e : window.location.protocol + "//" + window.location.hostname + e
    }
      , r = {};
    return {
        ...
        getCanvasBitmapState: function() {
            ...
            var e = $.Deferred(), r, i = new Uint8Array(t.config.place_canvas_width * t.config.place_canvas_height), s = 0;
            if (window.fetch)
                fetch(n("/api/place/board-bitmap"), {
                    ...
                    function n(t) {
                        t.read().then(function(s) {
                            s.done ? e.resolve(r, i) : (o(s.value),
                            n(t))
                        })
                    }
...
!r.placeModule("audio", function(e) {
    ...
    }),
    {
        ...
        init: function() {
            ...
            this.audioGain.connect(this.audioCtx.destination)) : (this.enabled = !1,
            this.isSupported = !1)
        },
        disable: function() {
            this.enabled = !1
        ...
        playClip: function(e, t) {
            if (!this.enabled)
                return;
            t = t === undefined ? this.globalVolume : Math.max(0, Math.min(1, t)),
            this.audioGain.gain.value = t;
            var n = this.audioCtx.currentTime, r, i, s;
            for (var o = 0; o < e.length; o++)
                r = e[o],
                i = r[0],
                s = r[1],
                i && this.scheduleAudio(i, n, n + s),
                n += s
        },
...
!r.placeModule("camera", function(e) {
    ...
    return {
        ...
        tick: function() {
            return this.isDirty ? (this.isDirty = !1,
            !0) : !1
        },
        updateScale: function(e) {
            this.isDirty = !0,
            t(this.zoomElement).css({
                transform: "scale(" + e + "," + e + ")"
            })
        },
        updateTranslate: function(e, n) {
            this.isDirty = !0,
            t(this.panElement).css({
    ...
    return {
        ...
        updateTransform: function(e, n, r) {
            if (!this.enabled)
                return;
            t(this.hand).css({
                transform: "translateX(" + e + "px) " + "translateY(" + n + "px) " + "rotateZ(" + r + "deg)"
            })
        },
        updateCursorTransform: function(e, n) {
            if (!this.enabled)
                return;
            t(this.cursor).css({
                transform: "translateX(" + (e - 20) + "px) " + "translateY(" + (n - 20) + "px)"
            })
        },
        showCursor: function() {
            this.visible = !0;
...
!r.placeModule("inspector", function(e) {
    var t = _.template('<div class="place-inspector-user-row"><a href="https://www.reddit.com/user/<%- username %>" target="_blank">u/<%- username %></a></div><div class="place-inspector-location-row">(<%- x %>, <%- y %>)</div><div class="place-inspector-timestamp-row"><%- timestamp %></div><div class="place-inspector-link-row"><input type="text" value="<%- link %>"></div>');
    return {
        isVisible: !1,
        init: function(e) {
            this.$el = $(e),
    ...
    return {
        ...
        init: function() {
            window.addEventListener("keydown", function(e) {
                if (!this.enabled)
                    return;
                var n = this.getKeyName(e.keyCode, e.keyIdentifier || e.key);
                n in this.keys && (this.keys[n] |= t,
                e.preventDefault())
            }
            .bind(this)),
        ...
        getKeyName: function(e, t) {
            t.slice(0, 2) === "U+" && (t = String.fromCharCode(e)),
            t = t.toUpperCase();
...
!r.placeModule("palette", function(e) {
    ...
    return {
        ...
        init: function(e) {
            this.el = e,
            t(e).removeClass("place-uninitialized"),
            this.initialized = !0
        },
        generateSwatches: function(e) {
            if (!this.initialized)
                return;
            t(this.el).children("." + this.SWATCH_CLASS).remove(),
        ...
        buildSwatch: function(e, n) {
            ...
            return t(r).css("backgroundColor", e).data("color", n).addClass("place-swatch"),
            this.el.appendChild(r),
            r
        },
        highlightSwatch: function(e) {
            t(this.el).children(".place-swatch").eq(e).addClass("place-selected")
        },
        ...
        startTimer: function(e) {
            ...
            var t = function() {
                ...
                var i = (n < 10 ? "0" : "") + n
                  , s = (r < 10 ? "0" : "") + r
                  , o = s + ":" + i;
                o !== this.lastDisplayText && (this.lastDisplayText = o,
                this.setText(o)),
                t || this.stopTimer()
            }
            .bind(this);
            t(),
            n = setInterval(t, this.REFRESH_INTERVAL_MS)
        },
        stopTimer: function() {
            n && (n = clearInterval(n))
        }
...
!r.placeModule("client", function(e) {
    function U(e, t, n, r, i, s) {
        return r * t.reduce(function(t, r) {
            ...
            return o ? o > n ? t + 1 / Math.pow(o, i) : t + Math.pow(n, s - i) / Math.pow(o, s) : t
        }, 0)
    }
    var t = e("jQuery"), n = e("r"), r = e("store"), i = e("audio"), s = e("camera"), o = e("camerabutton"), u = e("canvasse"), a = e("coordinates"), f = e("hand"), l = e("inspector"), c = e("keyboard"), h = e("mollyguard"), p = e("mutebutton"), d = e("notificationbutton"), v = e("notifications"), m = e("palette"), g = e("api"), y = e("timer"), b = e("utils").lerp, w = e("zoombutton"), E = e("utils").parseHexColor, S = e("utils").clamp, x = e("utils").getDistance, T = e("utils").normalizeVector, N = 15, C = "#FFFFFF", k = 4294967295, L = i.compileClip([["E7", 1 / 32], ["C7", 1 / 32], ["A6", 1 / 16]]), A = i.compileClip([["G7", 1 / 32], ["E7", 1 / 32], ["C6", 1 / 16]]), O = i.compileClip([["C7", 1 / 32], ["E7", 1 / 32], ["G8", 1 / 16]]), M = i.compileClip([["E4", 1 / 32], ["C4", 1 / 32], ["A3", 1 / 16]]), _ = i.compileClip([["D6", 1 / 32], ["C6", 1 / 32], ["A5", 1 / 16]]), D = _.slice().reverse(), P = [], H = 0, B = 100, j, F = 0, I = 1, q = .5, R = 1;
    return {
        ...
        init: function(e, t, n, s, o) {
            ...
            this.setOffset(n | 0, s | 0),
            i.setGlobalVolume(this.VOLUME_LEVEL),
            ...
            a && this._setAudioEnabled(!1),
            this.getZoomButtonClicked() || w.highlight(!0);
            var f = parseInt(r.safeGet("iOS-Notifications-Enabled"), 10) === 1;
            f && d.showNotificationOn(),
            this.state = new Uint8Array(new ArrayBuffer(u.width * u.height));
            if (!e)
                return;
            g.getTimeToWait().then(function(t, n, r) {
                this.setCooldownTime(t)
            }
            .bind(this), function(t, n, r) {
        ...
        setColorPalette: function(e) {
            ...
            this.palette = e,
            m.generateSwatches(e);
            var n = new DataView(new ArrayBuffer(4));
            n.setUint8(0, 255),
            this.paletteABGR = e.map(function(e) {
                var t = E(e);
                return n.setUint8(1, t.blue),
                n.setUint8(2, t.green),
                n.setUint8(3, t.red),
                n.getUint32(0)
            }),
        ...
        setCooldownTime: function(e) {
            ...
            .bind(this), e),
            e && (y.startTimer(this.cooldownEndTime),
            y.show()),
            this.cooldownPromise = r.promise(),
            e && h.showLocked(),
            this.cooldownPromise
        },
        ...
        getCooldownTimeRemaining: function() {
            var e = Date.now()
              , t = this.cooldownEndTime - e;
            return Math.max(0, t)
        },
        tick: function() {
            var e = !1;
            this._zoom !== this.zoom && (this._zoom = b(this._zoom, this.zoom, this.ZOOM_LERP_SPEED),
            s.updateScale(this._zoom),
            e = !0),
            ...
            this._currentDirection.x !== this.currentDirection.x && (this._currentDirection.x = b(this._currentDirection.x, this.currentDirection.x, this.KEYBOARD_PAN_LERP_SPEED)),
            this._currentDirection.y !== this.currentDirection.y && (this._currentDirection.y = b(this._currentDirection.y, this.currentDirection.y, this.KEYBOARD_PAN_LERP_SPEED));
            var t = this.ZOOM_MAX_SCALE / this._zoom * this.KEYBOARD_PAN_SPEED;
            this.panX -= this._currentDirection.x * t,
            this.panY -= this._currentDirection.y * t;
            var n = !1;
            this._panX !== this.panX && (this._panX = b(this._panX, this.panX, this.PAN_LERP_SPEED),
            n = !0),
            this._panY !== this.panY && (this._panY = b(this._panY, this.panY, this.PAN_LERP_SPEED),
            n = !0),
            e = e || n;
            if (n) {
                s.updateTranslate(this._panX, this._panY);
                var r = this.getCameraLocationFromOffset(this._panX, this._panY);
                a.setCoordinates(Math.round(r.x), Math.round(r.y))
            }
            return e
        },
        getPaletteColor: function(e) {
            return e = Math.min(N, Math.max(0, e | 0)),
            this.palette[e % this.palette.length] || C
        },
        getPaletteColorABGR: function(e) {
            return e = Math.min(N, Math.max(0, e | 0)),
            this.paletteABGR[e % this.paletteABGR.length] || k
        },
        ...
        setColor: function(e, t) {
            ...
            this.colorIndex = e,
            this.paletteColor = this.getPaletteColor(e),
            this.paletteColorABGR = this.getPaletteColorABGR(e),
            f.updateColor(this.paletteColor),
            this.isZoomedIn && f.showCursor(),
            m.clearSwatchHighlights(),
            m.highlightSwatch(e),
            t && i.playClip(O)
        },
        ...
        setZoom: function(e) {
            this._zoom = this.zoom = e,
            this.isZoomedIn = e === this.ZOOM_MAX_SCALE,
            this.isZoomedIn ? this.hasColor() && f.showCursor() : f.hideCursor(),
            s.updateScale(this._zoom)
        },
        setOffset: function(e, t) {
            this._panX = this.panX = e,
            this._panY = this.panY = t,
            s.updateTranslate(this._panX, this._panY);
        ...
        getLocationFromCursorPosition: function(e, t) {
            ...
            return {
                x: Math.round(e / this.zoom + n.width / 2 - r.width / (2 * this.zoom) - this.panX),
                y: Math.round(t / this.zoom + n.height / 2 - r.height / (2 * this.zoom) - this.panY)
            }
        },
        getCursorPositionFromLocation: function(e, t) {
            var n = this.getCanvasSize()
              , r = this.getContainerSize();
            return {
                x: this.zoom * (e - n.width / 2 + r.width / (2 * this.zoom) + this.panX),
                y: this.zoom * (t - n.height / 2 + r.height / (2 * this.zoom) + this.panY)
            }
        },
        ...
        attemptToFireiOSLocalNotification: function() {
            if (parseInt(r.safeGet("iOS-Notifications-Enabled"), 10) === 1) {
                var e = window.navigator.userAgent.indexOf("iPhone") > -1 && window.innerHeight > 200;
                if (e && typeof webkit != "undefined")
                    try {
                        webkit.messageHandlers.tilePlacedHandler.postMessage(this.cooldown / 1e3)
                    } catch (t) {}
            }
        },
        drawTile: function(e, t) {
            ...
            this.state[n] = this.colorIndex,
            u.drawTileAt(e, t, this.paletteColorABGR),
            this.clearColor(!1),
            this.attemptToFireiOSLocalNotification(),
            g.draw(e, t, this.colorIndex).then(function(t, n, r) {
                return this.setCooldownTime(1e3 * t.wait_seconds)
            }
            .bind(this)).fail(function(t, n, r) {
                this.enable(),
                h.showUnlocked(),
                y.hide()
            }
        ...
        inspectTile: function(e, t) {
            this.interact(),
            g.getPixelInfo(e, t).then(function(r, i, s) {
                "color"in r ? (this.setTargetCameraLocation(e, t),
                l.show(r.x, r.y, r.user_name, r.timestamp)) : l.isVisible && l.hide()
            }
            .bind(this), function(t, n, r) {
                console.error(t)
            }
        ...
        toggleZoom: function(e, t) {
            this.interact(),
            this.isZoomedIn ? (this.setTargetZoom(this.ZOOM_MIN_SCALE),
            i.playClip(_),
            w.showZoomIn(),
            f.hideCursor()) : (this.hasColor() && f.showCursor(),
            this.setTargetZoom(this.ZOOM_MAX_SCALE),
            e !== undefined && t !== undefined && this.setTargetOffset(e, t),
            i.playClip(D),
            w.showZoomOut()),
        ...
        setContainerSize: function(e, t) {
            this.containerSize.width = e,
            this.containerSize.height = t
        },
        ...
        injectHeaders: function(e) {
            g.injectHeaders(e);
            var t = window.navigator.userAgent.indexOf("iPhone") > -1 && window.innerHeight > 200;
            t && d.show()
        },
        _setAudioEnabled: function(e) {
            ...
            e ? (i.enable(),
            p.showMute(),
            r.remove("place-audio-isDisabled")) : (i.disable(),
            p.showUnmute(),
            r.safeSet("place-audio-isDisabled", "1"))
        },
        ...
        toggleVolume: function() {
            this._setAudioEnabled(!i.enabled),
            i.playClip(O)
        },
        toggleNotificationButton: function() {
            var e = parseInt(r.safeGet("iOS-Notifications-Enabled"), 10) === 1;
            e ? (r.safeSet("iOS-Notifications-Enabled", "0"),
            d.showNotificationOff()) : (r.safeSet("iOS-Notifications-Enabled", "1"),
            d.showNotificationOn())
        },
        setVolume: function(e) {
            if (!i.isSupported)
                return;
            e ? i.globalVolume || this._setAudioEnabled(!0) : this._setAudioEnabled(!1),
            i.setGlobalVolume(e),
            i.playClip(O)
        },
        interact: function() {
        ...
        playTileSoundAtDistance: function(e) {
            if (e > this.MAXIMUM_AUDIBLE_DISTANCE)
                return;
            var t = Date.now();
            if (t - this.lastWorldAudioTime < this.MAX_WORLD_AUDIO_RATE)
                return;
        ...
        toggleAutoCamera: function() {
            this.autoCameraEnabled ? this.disableAutoCamera() : this.enableAutoCamera()
        },
        enableAutoCamera: function() {
            if (this.autoCameraEnabled)
                return;
            this.autoCameraEnabled = !0,
            o.showDisable(),
...
!r.placeModule("cursor", function(e) {
    ...
    return {
        ...
        tick: function() {
            ...
            if (this._x !== this.x) {
                e = !0;
                var r = this.x - this._x
                  , i = Math.abs(r);
                this._x = n(this._x, this.x, this.CURSOR_TRANSLATE_LERP),
                i < this.MIN_CURSOR_LERP_DELTA && (this._x = this.x);
                var s = r > 0 ? -1 : 1;
            ...
            if (this._y !== this.y) {
                ...
                this._y = n(this._y, this.y, this.CURSOR_TRANSLATE_LERP),
                Math.abs(o) < this.MIN_CURSOR_LERP_DELTA && (this._y = this.y)
            }
            if (this._rotateZ !== this.rotateZ) {
                e = !0;
                var u = this.rotateZ - this._rotateZ;
                this._rotateZ = n(this._rotateZ, this.rotateZ, this.CURSOR_ROTATE_LERP),
                Math.abs(u) < this.MIN_CURSOR_LERP_DELTA && (this._rotateZ = this.rotateZ)
            }
        ...
        setCursorUp: function(e, t) {
            ...
            this.upY = t,
            this.setPosition(e, t),
            this.dragDistance = r(this.upX - this.downX, this.upY - this.downY),
            this.didDrag = this.dragDistance >= this.MIN_DRAG_DISTANCE
        },
        setPosition: function(e, n) {
            this._x = this.x = e,
            this._y = this.y = n,
            t.updateTransform(e, n, 0)
        },
...
!r.placeModule("world", function(e) {
    ...
    return {
        ...
        drawTile: function(e, t, i) {
            var i = r.getPaletteColorABGR(i)
              , s = n.getIndexFromCoords(e, t);
            r.state[s] = this.colorIndex,
            this.enabled ? n.drawTileAt(e, t, i) : n.drawTileToBuffer(e, t, i),
            r.receiveTile(e, t)
        },
    ...
    return {
        container: {
            ...
            mousemove: function(e) {
                ...
                t.interact();
                var f = (n.x - n.downX) / t.zoom
                  , l = (n.y - n.downY) / t.zoom;
                n.setPosition(r.x, r.y);
                if (!t.isPanEnabled)
                    return;
                var c = (r.x - n.downX) / t.zoom
                  , h = (r.y - n.downY) / t.zoom;
...
!r.placeModule("canvasevents", function(e) {
    ...
    return {
        mouseup: function(e) {
            if (e.which === 3)
                return;
            var r = Math.round(e.offsetX)
              , i = Math.round(e.offsetY);
            if (n.didDrag)
                return;
            if (!t.isZoomedIn) {
